...
const SectionCard = ({ title, buttonText, setModal, onClick }) => {
  ...
  return (
    <div className="bg-white rounded-[15px] shadow-lg p-6 m-4 text-center 
                  w-full sm:w-[calc(50%-30px)] md:w-[calc(35%-30px)] 
      ...
      <button
        className="bg-blue-600 text-white px-5 py-3 rounded-lg text-lg 
                 transition-colors duration-300 hover:bg-blue-800 w-2/3"
        onClick={handleClick}
      >
        {buttonText}
      </button>
